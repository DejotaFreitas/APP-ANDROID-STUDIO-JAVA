...
public class ImgLoadUsuario extends AsyncTask<String, Void, Bitmap>{
    ...
    public ImgLoadUsuario(ImageView imgView, Integer id, String dominio, String imgPathServer) {
    ...
    protected void onPostExecute(Bitmap bitmap) {
        if (bitmap != null){
            ...
            Global.usuarioImg.put(id, bitmap);
        }
    }
