...
import com.dejota.petadote.global.ImgGlobal;

import java.io.InputStream;
import java.net.URL;

public class ImgLoadUrlSaveImgGlobal extends AsyncTask<String, Void, Bitmap>{
    ...
    public ImgLoadUrlSaveImgGlobal(ImageView imgView, Integer id, String dominio, String imgPathServer) {
